...
constexpr auto qt_meta_stringdata_CLASSRFID_DLLENDCLASS = QtMocHelpers::stringData(
    "RFID_DLL",
    "signalCard",
    "",
    "QString&",
...
void RFID_DLL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalCard((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &RFID_DLL::signalCard; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RFID_DLL::signalCard(QString & _t1)
{
